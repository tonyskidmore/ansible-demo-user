...
#
# Modified by @tonyskidmore Feb-2018
# 
# Adding lines arounnd 620 to be able to group by labels for demo purposes
#
#
#                labels = inspect.get('Config', dict()).get('Labels')
#                owner = labels.get('owner')
#                if owner:
#                    self.groups[owner].append(name)
#
DOCUMENTATION = '''
